...
begin
  with Installer do
    ...
    t.Dependencies.AddUnit('gtk4int');
    t.Dependencies.AddUnit('interfaces');
    t.Dependencies.AddUnit('gtk4cellrenderer');
    t.Dependencies.AddUnit('gtk4objects');
    t.Dependencies.AddUnit('gtk4private');
    t.Dependencies.AddUnit('gtk4procs');
    t.Dependencies.AddUnit('gtk4widgets');
    t.Dependencies.AddUnit('gtk4boxes');
    t.Dependencies.AddUnit('gtk4wsbuttons');
    t.Dependencies.AddUnit('gtk4wschecklst');
    t.Dependencies.AddUnit('gtk4wscomctrls');
    t.Dependencies.AddUnit('gtk4wscontrols');
    t.Dependencies.AddUnit('gtk4wsextctrls');
    t.Dependencies.AddUnit('gtk4wsfactory');
    t.Dependencies.AddUnit('gtk4wsforms');
    t.Dependencies.AddUnit('gtk4wsimglist');
    t.Dependencies.AddUnit('gtk4wsmenus');
    t.Dependencies.AddUnit('gtk4wsspin');
    t.Dependencies.AddUnit('gtk4wsstdctrls');
    t.Dependencies.AddUnit('gtk4wscalendar');
    t.Dependencies.AddUnit('gtk4wsdialogs');
    t.Dependencies.AddUnit('gtk4wsextdlgs');
    t.Dependencies.AddUnit('gtk4wssplitter');
    t.Dependencies.AddUnit('gtk4wstrayicon');
    t.Dependencies.AddUnit('lazatk1');
    t.Dependencies.AddUnit('lazcairo1');
    t.Dependencies.AddUnit('lazgdk4');
    t.Dependencies.AddUnit('lazgdkpixbuf2');
    t.Dependencies.AddUnit('lazgio2');
    t.Dependencies.AddUnit('lazglib2');
    t.Dependencies.AddUnit('lazgmodule2');
    t.Dependencies.AddUnit('lazgobject2');
    t.Dependencies.AddUnit('lazgtk4');
    t.Dependencies.AddUnit('lazgtk4_compat');
    t.Dependencies.AddUnit('lazgsk4');
    t.Dependencies.AddUnit('lazpango1');
    t.Dependencies.AddUnit('lazpangocairo1');
    t.Dependencies.AddUnit('lazxlib2');
    t.Dependencies.AddUnit('lazharfbuzz0');
    t.Dependencies.AddUnit('lazfreetype2_2');
    t.Dependencies.AddUnit('alllclintfunits');
    t.Dependencies.AddUnit('interfaces');
    ...
    P.Targets.AddImplicitUnit('gtk4/gtk4int.pas');
    P.Targets.AddImplicitUnit('gtk4/interfaces.pp');
    P.Targets.AddImplicitUnit('gtk4/gtk4cellrenderer.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4objects.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4private.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4procs.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4widgets.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4boxes.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4wsbuttons.pp');
    P.Targets.AddImplicitUnit('gtk4/gtk4wschecklst.pp');
    P.Targets.AddImplicitUnit('gtk4/gtk4wscomctrls.pp');
    P.Targets.AddImplicitUnit('gtk4/gtk4wscontrols.pp');
    P.Targets.AddImplicitUnit('gtk4/gtk4wsextctrls.pp');
    P.Targets.AddImplicitUnit('gtk4/gtk4wsfactory.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4wsforms.pp');
    P.Targets.AddImplicitUnit('gtk4/gtk4wsimglist.pp');
    P.Targets.AddImplicitUnit('gtk4/gtk4wsmenus.pp');
    P.Targets.AddImplicitUnit('gtk4/gtk4wsspin.pp');
    P.Targets.AddImplicitUnit('gtk4/gtk4wsstdctrls.pp');
    P.Targets.AddImplicitUnit('gtk4/gtk4wscalendar.pp');
    P.Targets.AddImplicitUnit('gtk4/gtk4wsdialogs.pp');
    P.Targets.AddImplicitUnit('gtk4/gtk4wsextdlgs.pp');
    P.Targets.AddImplicitUnit('gtk4/gtk4wssplitter.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4wstrayicon.pas');
    P.Targets.AddImplicitUnit('gtk4/alllclintfunits.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4bindings/lazatk1.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4bindings/lazcairo1.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4bindings/lazfreetype2_2.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4bindings/lazgdk4.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4bindings/lazgdkpixbuf2.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4bindings/lazgio2.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4bindings/lazglib2.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4bindings/lazgmodule2.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4bindings/lazgobject2.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4bindings/lazgsk4.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4bindings/lazgtk4.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4bindings/lazgtk4_compat.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4bindings/lazharfbuzz0.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4bindings/lazpango1.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4bindings/lazpangocairo1.pas');
    P.Targets.AddImplicitUnit('gtk4/gtk4bindings/lazxlib2.pas');
