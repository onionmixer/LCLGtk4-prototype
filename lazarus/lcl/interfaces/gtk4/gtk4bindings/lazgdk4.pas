...
const
  {$ifdef MsWindows}
  LazGdk4_library = 'libgtk-4-1.dll';
  {$else}
  LazGdk4_library = 'libgtk-4.so.1';
  {$endif}
...
function gdk_app_launch_context_get_type: TGType; cdecl; external LazGdk4_library name 'gdk_app_launch_context_get_type';
function gdk_cairo_region_create_from_surface(surface: Pcairo_surface_t): Pcairo_region_t; cdecl; external LazGdk4_library name 'gdk_cairo_region_create_from_surface';
function gdk_cursor_get_type: TGType; cdecl; external LazGdk4_library name 'gdk_cursor_get_type';
function gdk_cursor_new_from_name(display: PGdkDisplay; name: Pgchar): PGdkCursor; cdecl; external LazGdk4_library name 'gdk_cursor_new_from_name';
function gdk_device_get_display(device: PGdkDevice): PGdkDisplay; cdecl; external LazGdk4_library name 'gdk_device_get_display';
function gdk_device_get_has_cursor(device: PGdkDevice): gboolean; cdecl; external LazGdk4_library name 'gdk_device_get_has_cursor';
function gdk_device_get_name(device: PGdkDevice): Pgchar; cdecl; external LazGdk4_library name 'gdk_device_get_name';
function gdk_device_get_product_id(device: PGdkDevice): Pgchar; cdecl; external LazGdk4_library name 'gdk_device_get_product_id';
function gdk_device_get_seat(device: PGdkDevice): PGdkSeat; cdecl; external LazGdk4_library name 'gdk_device_get_seat';
function gdk_device_get_source(device: PGdkDevice): TGdkInputSource; cdecl; external LazGdk4_library name 'gdk_device_get_source';
function gdk_device_get_type: TGType; cdecl; external LazGdk4_library name 'gdk_device_get_type';
function gdk_device_get_vendor_id(device: PGdkDevice): Pgchar; cdecl; external LazGdk4_library name 'gdk_device_get_vendor_id';
function gdk_device_pad_get_feature_group(pad: PGdkDevicePad; feature: TGdkDevicePadFeature; feature_idx: gint): gint; cdecl; external LazGdk4_library name 'gdk_device_pad_get_feature_group';
function gdk_device_pad_get_group_n_modes(pad: PGdkDevicePad; group_idx: gint): gint; cdecl; external LazGdk4_library name 'gdk_device_pad_get_group_n_modes';
function gdk_device_pad_get_n_features(pad: PGdkDevicePad; feature: TGdkDevicePadFeature): gint; cdecl; external LazGdk4_library name 'gdk_device_pad_get_n_features';
function gdk_device_pad_get_n_groups(pad: PGdkDevicePad): gint; cdecl; external LazGdk4_library name 'gdk_device_pad_get_n_groups';
function gdk_device_pad_get_type: TGType; cdecl; external LazGdk4_library name 'gdk_device_pad_get_type';
function gdk_device_tool_get_hardware_id(tool: PGdkDeviceTool): guint64; cdecl; external LazGdk4_library name 'gdk_device_tool_get_hardware_id';
function gdk_device_tool_get_serial(tool: PGdkDeviceTool): guint64; cdecl; external LazGdk4_library name 'gdk_device_tool_get_serial';
function gdk_device_tool_get_tool_type(tool: PGdkDeviceTool): TGdkDeviceToolType; cdecl; external LazGdk4_library name 'gdk_device_tool_get_tool_type';
function gdk_device_tool_get_type: TGType; cdecl; external LazGdk4_library name 'gdk_device_tool_get_type';
function gdk_display_device_is_grabbed(display: PGdkDisplay; device: PGdkDevice): gboolean; cdecl; external LazGdk4_library name 'gdk_display_device_is_grabbed';
function gdk_display_get_app_launch_context(display: PGdkDisplay): PGdkAppLaunchContext; cdecl; external LazGdk4_library name 'gdk_display_get_app_launch_context';
function gdk_display_get_default: PGdkDisplay; cdecl; external LazGdk4_library name 'gdk_display_get_default';
function gdk_display_get_default_seat(display: PGdkDisplay): PGdkSeat; cdecl; external LazGdk4_library name 'gdk_display_get_default_seat';
function gdk_display_get_name(display: PGdkDisplay): Pgchar; cdecl; external LazGdk4_library name 'gdk_display_get_name';
function gdk_display_get_type: TGType; cdecl; external LazGdk4_library name 'gdk_display_get_type';
function gdk_display_is_closed(display: PGdkDisplay): gboolean; cdecl; external LazGdk4_library name 'gdk_display_is_closed';
function gdk_display_list_seats(display: PGdkDisplay): PGList; cdecl; external LazGdk4_library name 'gdk_display_list_seats';
function gdk_display_manager_get: PGdkDisplayManager; cdecl; external LazGdk4_library name 'gdk_display_manager_get';
function gdk_display_manager_get_default_display(manager: PGdkDisplayManager): PGdkDisplay; cdecl; external LazGdk4_library name 'gdk_display_manager_get_default_display';
function gdk_display_manager_get_type: TGType; cdecl; external LazGdk4_library name 'gdk_display_manager_get_type';
function gdk_display_manager_list_displays(manager: PGdkDisplayManager): PGSList; cdecl; external LazGdk4_library name 'gdk_display_manager_list_displays';
function gdk_display_manager_open_display(manager: PGdkDisplayManager; name: Pgchar): PGdkDisplay; cdecl; external LazGdk4_library name 'gdk_display_manager_open_display';
function gdk_display_open(display_name: Pgchar): PGdkDisplay; cdecl; external LazGdk4_library name 'gdk_display_open';
function gdk_display_supports_input_shapes(display: PGdkDisplay): gboolean; cdecl; external LazGdk4_library name 'gdk_display_supports_input_shapes';
function gdk_drag_begin(window: PGdkWindow; targets: PGList): PGdkDragContext; cdecl; external LazGdk4_library name 'gdk_drag_begin';
function gdk_event_get_axis(event: PGdkEvent; axis_use: TGdkAxisUse; value: Pgdouble): gboolean; cdecl; external LazGdk4_library name 'gdk_event_get_axis';
function gdk_event_get_device(event: PGdkEvent): PGdkDevice; cdecl; external LazGdk4_library name 'gdk_event_get_device';
function gdk_event_get_device_tool(event: PGdkEvent): PGdkDeviceTool; cdecl; external LazGdk4_library name 'gdk_event_get_device_tool';
function gdk_event_get_event_sequence(event: PGdkEvent): PGdkEventSequence; cdecl; external LazGdk4_library name 'gdk_event_get_event_sequence';
function gdk_event_get_event_type(event: PGdkEvent): TGdkEventType; cdecl; external LazGdk4_library name 'gdk_event_get_event_type';
function gdk_event_get_pointer_emulated(event: PGdkEvent): gboolean; cdecl; external LazGdk4_library name 'gdk_event_get_pointer_emulated';
function gdk_event_get_seat(event: PGdkEvent): PGdkSeat; cdecl; external LazGdk4_library name 'gdk_event_get_seat';
function gdk_event_get_time(event: PGdkEvent): guint32; cdecl; external LazGdk4_library name 'gdk_event_get_time';
function gdk_event_sequence_get_type: TGType; cdecl; external LazGdk4_library name 'gdk_event_sequence_get_type';
function gdk_event_triggers_context_menu(event: PGdkEvent): gboolean; cdecl; external LazGdk4_library name 'gdk_event_triggers_context_menu';
function gdk_events_get_angle(event1: PGdkEvent; event2: PGdkEvent; angle: Pgdouble): gboolean; cdecl; external LazGdk4_library name 'gdk_events_get_angle';
function gdk_events_get_center(event1: PGdkEvent; event2: PGdkEvent; x: Pgdouble; y: Pgdouble): gboolean; cdecl; external LazGdk4_library name 'gdk_events_get_center';
function gdk_events_get_distance(event1: PGdkEvent; event2: PGdkEvent; distance: Pgdouble): gboolean; cdecl; external LazGdk4_library name 'gdk_events_get_distance';
function gdk_frame_clock_get_current_timings(frame_clock: PGdkFrameClock): PGdkFrameTimings; cdecl; external LazGdk4_library name 'gdk_frame_clock_get_current_timings';
function gdk_frame_clock_get_frame_counter(frame_clock: PGdkFrameClock): gint64; cdecl; external LazGdk4_library name 'gdk_frame_clock_get_frame_counter';
function gdk_frame_clock_get_frame_time(frame_clock: PGdkFrameClock): gint64; cdecl; external LazGdk4_library name 'gdk_frame_clock_get_frame_time';
function gdk_frame_clock_get_history_start(frame_clock: PGdkFrameClock): gint64; cdecl; external LazGdk4_library name 'gdk_frame_clock_get_history_start';
function gdk_frame_clock_get_timings(frame_clock: PGdkFrameClock; frame_counter: gint64): PGdkFrameTimings; cdecl; external LazGdk4_library name 'gdk_frame_clock_get_timings';
function gdk_frame_clock_get_type: TGType; cdecl; external LazGdk4_library name 'gdk_frame_clock_get_type';
function gdk_frame_timings_get_complete(timings: PGdkFrameTimings): gboolean; cdecl; external LazGdk4_library name 'gdk_frame_timings_get_complete';
function gdk_frame_timings_get_frame_counter(timings: PGdkFrameTimings): gint64; cdecl; external LazGdk4_library name 'gdk_frame_timings_get_frame_counter';
function gdk_frame_timings_get_frame_time(timings: PGdkFrameTimings): gint64; cdecl; external LazGdk4_library name 'gdk_frame_timings_get_frame_time';
function gdk_frame_timings_get_predicted_presentation_time(timings: PGdkFrameTimings): gint64; cdecl; external LazGdk4_library name 'gdk_frame_timings_get_predicted_presentation_time';
function gdk_frame_timings_get_presentation_time(timings: PGdkFrameTimings): gint64; cdecl; external LazGdk4_library name 'gdk_frame_timings_get_presentation_time';
function gdk_frame_timings_get_refresh_interval(timings: PGdkFrameTimings): gint64; cdecl; external LazGdk4_library name 'gdk_frame_timings_get_refresh_interval';
function gdk_frame_timings_get_type: TGType; cdecl; external LazGdk4_library name 'gdk_frame_timings_get_type';
function gdk_frame_timings_ref(timings: PGdkFrameTimings): PGdkFrameTimings; cdecl; external LazGdk4_library name 'gdk_frame_timings_ref';
function gdk_gl_context_get_current: PGdkGLContext; cdecl; external LazGdk4_library name 'gdk_gl_context_get_current';
function gdk_gl_context_get_debug_enabled(context: PGdkGLContext): gboolean; cdecl; external LazGdk4_library name 'gdk_gl_context_get_debug_enabled';
function gdk_gl_context_get_display(context: PGdkGLContext): PGdkDisplay; cdecl; external LazGdk4_library name 'gdk_gl_context_get_display';
function gdk_gl_context_get_forward_compatible(context: PGdkGLContext): gboolean; cdecl; external LazGdk4_library name 'gdk_gl_context_get_forward_compatible';
function gdk_gl_context_get_shared_context(context: PGdkGLContext): PGdkGLContext; cdecl; external LazGdk4_library name 'gdk_gl_context_get_shared_context';
function gdk_gl_context_get_type: TGType; cdecl; external LazGdk4_library name 'gdk_gl_context_get_type';
function gdk_gl_context_get_use_es(context: PGdkGLContext): gboolean; cdecl; external LazGdk4_library name 'gdk_gl_context_get_use_es';
function gdk_gl_context_is_legacy(context: PGdkGLContext): gboolean; cdecl; external LazGdk4_library name 'gdk_gl_context_is_legacy';
function gdk_gl_context_realize(context: PGdkGLContext; error: PPGError): gboolean; cdecl; external LazGdk4_library name 'gdk_gl_context_realize';
function gdk_gl_error_quark: TGQuark; cdecl; external LazGdk4_library name 'gdk_gl_error_quark';
function gdk_keyval_from_name(keyval_name: Pgchar): guint; cdecl; external LazGdk4_library name 'gdk_keyval_from_name';
function gdk_keyval_is_lower(keyval: guint): gboolean; cdecl; external LazGdk4_library name 'gdk_keyval_is_lower';
function gdk_keyval_is_upper(keyval: guint): gboolean; cdecl; external LazGdk4_library name 'gdk_keyval_is_upper';
function gdk_keyval_name(keyval: guint): Pgchar; cdecl; external LazGdk4_library name 'gdk_keyval_name';
function gdk_keyval_to_lower(keyval: guint): guint; cdecl; external LazGdk4_library name 'gdk_keyval_to_lower';
function gdk_keyval_to_unicode(keyval: guint): guint32; cdecl; external LazGdk4_library name 'gdk_keyval_to_unicode';
function gdk_keyval_to_upper(keyval: guint): guint; cdecl; external LazGdk4_library name 'gdk_keyval_to_upper';
function gdk_monitor_get_display(monitor: PGdkMonitor): PGdkDisplay; cdecl; external LazGdk4_library name 'gdk_monitor_get_display';
function gdk_monitor_get_height_mm(monitor: PGdkMonitor): gint; cdecl; external LazGdk4_library name 'gdk_monitor_get_height_mm';
function gdk_monitor_get_manufacturer(monitor: PGdkMonitor): Pgchar; cdecl; external LazGdk4_library name 'gdk_monitor_get_manufacturer';
function gdk_monitor_get_model(monitor: PGdkMonitor): Pgchar; cdecl; external LazGdk4_library name 'gdk_monitor_get_model';
function gdk_monitor_get_refresh_rate(monitor: PGdkMonitor): gint; cdecl; external LazGdk4_library name 'gdk_monitor_get_refresh_rate';
function gdk_monitor_get_scale_factor(monitor: PGdkMonitor): gint; cdecl; external LazGdk4_library name 'gdk_monitor_get_scale_factor';
function gdk_monitor_get_subpixel_layout(monitor: PGdkMonitor): TGdkSubpixelLayout; cdecl; external LazGdk4_library name 'gdk_monitor_get_subpixel_layout';
function gdk_monitor_get_type: TGType; cdecl; external LazGdk4_library name 'gdk_monitor_get_type';
function gdk_monitor_get_width_mm(monitor: PGdkMonitor): gint; cdecl; external LazGdk4_library name 'gdk_monitor_get_width_mm';
function gdk_pango_layout_get_clip_region(layout: PPangoLayout; x_origin: gint; y_origin: gint; index_ranges: Pgint; n_ranges: gint): Pcairo_region_t; cdecl; external LazGdk4_library name 'gdk_pango_layout_get_clip_region';
function gdk_pango_layout_line_get_clip_region(line: PPangoLayoutLine; x_origin: gint; y_origin: gint; index_ranges: Pgint; n_ranges: gint): Pcairo_region_t; cdecl; external LazGdk4_library name 'gdk_pango_layout_line_get_clip_region';
function gdk_pixbuf_get_from_surface(surface: Pcairo_surface_t; src_x: gint; src_y: gint; width: gint; height: gint): PGdkPixbuf; cdecl; external LazGdk4_library name 'gdk_pixbuf_get_from_surface';
function gdk_rectangle_equal(rect1: PGdkRectangle; rect2: PGdkRectangle): gboolean; cdecl; external LazGdk4_library name 'gdk_rectangle_equal';
function gdk_rectangle_get_type: TGType; cdecl; external LazGdk4_library name 'gdk_rectangle_get_type';
function gdk_rectangle_intersect(src1: PGdkRectangle; src2: PGdkRectangle; dest: PGdkRectangle): gboolean; cdecl; external LazGdk4_library name 'gdk_rectangle_intersect';
function gdk_rgba_copy(rgba: PGdkRGBA): PGdkRGBA; cdecl; external LazGdk4_library name 'gdk_rgba_copy';
function gdk_rgba_equal(p1: PGdkRGBA; p2: PGdkRGBA): gboolean; cdecl; external LazGdk4_library name 'gdk_rgba_equal';
function gdk_rgba_get_type: TGType; cdecl; external LazGdk4_library name 'gdk_rgba_get_type';
function gdk_rgba_hash(p: PGdkRGBA): guint; cdecl; external LazGdk4_library name 'gdk_rgba_hash';
function gdk_rgba_parse(rgba: PGdkRGBA; spec: Pgchar): gboolean; cdecl; external LazGdk4_library name 'gdk_rgba_parse';
function gdk_rgba_to_string(rgba: PGdkRGBA): Pgchar; cdecl; external LazGdk4_library name 'gdk_rgba_to_string';
function gdk_seat_get_capabilities(seat: PGdkSeat): TGdkSeatCapabilities; cdecl; external LazGdk4_library name 'gdk_seat_get_capabilities';
function gdk_seat_get_display(seat: PGdkSeat): PGdkDisplay; cdecl; external LazGdk4_library name 'gdk_seat_get_display';
function gdk_seat_get_keyboard(seat: PGdkSeat): PGdkDevice; cdecl; external LazGdk4_library name 'gdk_seat_get_keyboard';
function gdk_seat_get_pointer(seat: PGdkSeat): PGdkDevice; cdecl; external LazGdk4_library name 'gdk_seat_get_pointer';
function gdk_seat_get_type: TGType; cdecl; external LazGdk4_library name 'gdk_seat_get_type';
function gdk_unicode_to_keyval(wc: guint32): guint; cdecl; external LazGdk4_library name 'gdk_unicode_to_keyval';
procedure gdk_app_launch_context_set_desktop(context: PGdkAppLaunchContext; desktop: gint); cdecl; external LazGdk4_library name 'gdk_app_launch_context_set_desktop';
procedure gdk_app_launch_context_set_icon(context: PGdkAppLaunchContext; icon: PGIcon); cdecl; external LazGdk4_library name 'gdk_app_launch_context_set_icon';
procedure gdk_app_launch_context_set_icon_name(context: PGdkAppLaunchContext; icon_name: Pgchar); cdecl; external LazGdk4_library name 'gdk_app_launch_context_set_icon_name';
procedure gdk_app_launch_context_set_timestamp(context: PGdkAppLaunchContext; timestamp: guint32); cdecl; external LazGdk4_library name 'gdk_app_launch_context_set_timestamp';
procedure gdk_cairo_draw_from_gl(cr: Pcairo_t; window: PGdkWindow; source: gint; source_type: gint; buffer_scale: gint; x: gint; y: gint; width: gint; height: gint); cdecl; external LazGdk4_library name 'gdk_cairo_draw_from_gl';
procedure gdk_cairo_rectangle(cr: Pcairo_t; rectangle: PGdkRectangle); cdecl; external LazGdk4_library name 'gdk_cairo_rectangle';
procedure gdk_cairo_region(cr: Pcairo_t; region: Pcairo_region_t); cdecl; external LazGdk4_library name 'gdk_cairo_region';
procedure gdk_cairo_set_source_pixbuf(cr: Pcairo_t; pixbuf: PGdkPixbuf; pixbuf_x: gdouble; pixbuf_y: gdouble); cdecl; external LazGdk4_library name 'gdk_cairo_set_source_pixbuf';
procedure gdk_cairo_set_source_rgba(cr: Pcairo_t; rgba: PGdkRGBA); cdecl; external LazGdk4_library name 'gdk_cairo_set_source_rgba';
procedure gdk_display_beep(display: PGdkDisplay); cdecl; external LazGdk4_library name 'gdk_display_beep';
procedure gdk_display_close(display: PGdkDisplay); cdecl; external LazGdk4_library name 'gdk_display_close';
procedure gdk_display_flush(display: PGdkDisplay); cdecl; external LazGdk4_library name 'gdk_display_flush';
procedure gdk_display_manager_set_default_display(manager: PGdkDisplayManager; display: PGdkDisplay); cdecl; external LazGdk4_library name 'gdk_display_manager_set_default_display';
procedure gdk_display_notify_startup_complete(display: PGdkDisplay; startup_id: Pgchar); cdecl; external LazGdk4_library name 'gdk_display_notify_startup_complete';
procedure gdk_display_put_event(display: PGdkDisplay; event: PGdkEvent); cdecl; external LazGdk4_library name 'gdk_display_put_event';
procedure gdk_display_sync(display: PGdkDisplay); cdecl; external LazGdk4_library name 'gdk_display_sync';
procedure gdk_drag_drop_done(context: PGdkDragContext; success: gboolean); cdecl; external LazGdk4_library name 'gdk_drag_drop_done';
procedure gdk_drop_finish(context: PGdkDragContext; success: gboolean; time_: guint32); cdecl; external LazGdk4_library name 'gdk_drop_finish';
procedure gdk_frame_clock_begin_updating(frame_clock: PGdkFrameClock); cdecl; external LazGdk4_library name 'gdk_frame_clock_begin_updating';
procedure gdk_frame_clock_end_updating(frame_clock: PGdkFrameClock); cdecl; external LazGdk4_library name 'gdk_frame_clock_end_updating';
procedure gdk_frame_clock_get_refresh_info(frame_clock: PGdkFrameClock; base_time: gint64; refresh_interval_return: Pgint64; presentation_time_return: Pgint64); cdecl; external LazGdk4_library name 'gdk_frame_clock_get_refresh_info';
procedure gdk_frame_clock_request_phase(frame_clock: PGdkFrameClock; phase: TGdkFrameClockPhase); cdecl; external LazGdk4_library name 'gdk_frame_clock_request_phase';
procedure gdk_frame_timings_unref(timings: PGdkFrameTimings); cdecl; external LazGdk4_library name 'gdk_frame_timings_unref';
procedure gdk_gl_context_clear_current; cdecl; external LazGdk4_library name 'gdk_gl_context_clear_current';
procedure gdk_gl_context_get_required_version(context: PGdkGLContext; major: Pgint; minor: Pgint); cdecl; external LazGdk4_library name 'gdk_gl_context_get_required_version';
procedure gdk_gl_context_get_version(context: PGdkGLContext; major: Pgint; minor: Pgint); cdecl; external LazGdk4_library name 'gdk_gl_context_get_version';
procedure gdk_gl_context_make_current(context: PGdkGLContext); cdecl; external LazGdk4_library name 'gdk_gl_context_make_current';
procedure gdk_gl_context_set_debug_enabled(context: PGdkGLContext; enabled: gboolean); cdecl; external LazGdk4_library name 'gdk_gl_context_set_debug_enabled';
procedure gdk_gl_context_set_forward_compatible(context: PGdkGLContext; compatible: gboolean); cdecl; external LazGdk4_library name 'gdk_gl_context_set_forward_compatible';
procedure gdk_gl_context_set_required_version(context: PGdkGLContext; major: gint; minor: gint); cdecl; external LazGdk4_library name 'gdk_gl_context_set_required_version';
procedure gdk_gl_context_set_use_es(context: PGdkGLContext; use_es: gint); cdecl; external LazGdk4_library name 'gdk_gl_context_set_use_es';
procedure gdk_keyval_convert_case(symbol: guint; lower: Pguint; upper: Pguint); cdecl; external LazGdk4_library name 'gdk_keyval_convert_case';
procedure gdk_monitor_get_geometry(monitor: PGdkMonitor; geometry: PGdkRectangle); cdecl; external LazGdk4_library name 'gdk_monitor_get_geometry';
procedure gdk_rectangle_union(src1: PGdkRectangle; src2: PGdkRectangle; dest: PGdkRectangle); cdecl; external LazGdk4_library name 'gdk_rectangle_union';
procedure gdk_rgba_free(rgba: PGdkRGBA); cdecl; external LazGdk4_library name 'gdk_rgba_free';
procedure gdk_set_allowed_backends(backends: Pgchar); cdecl; external LazGdk4_library name 'gdk_set_allowed_backends';
implementation
procedure TGdkAppLaunchContext.set_desktop(desktop: gint); cdecl;
begin
  LazGdk4.gdk_app_launch_context_set_desktop(@self, desktop);
end;

procedure TGdkAppLaunchContext.set_icon(icon: PGIcon); cdecl;
begin
  LazGdk4.gdk_app_launch_context_set_icon(@self, icon);
end;

procedure TGdkAppLaunchContext.set_icon_name(icon_name: Pgchar); cdecl;
begin
  LazGdk4.gdk_app_launch_context_set_icon_name(@self, icon_name);
end;
...
begin
  Result := LazGdk4.gdk_display_get_default_seat(@self);
end;
...
begin
  Result := LazGdk4.gdk_display_get_name(@self);
end;
...
begin
  Result := LazGdk4.gdk_display_is_closed(@self);
end;

function TGdkDisplay.list_seats: PGList; cdecl;
begin
  Result := LazGdk4.gdk_display_list_seats(@self);
end;

procedure TGdkDisplay.notify_startup_complete(startup_id: Pgchar); cdecl;
begin
  LazGdk4.gdk_display_notify_startup_complete(@self, startup_id);
end;
...
begin
  LazGdk4.gdk_display_put_event(@self, event);
end;
...
begin
  Result := LazGdk4.gdk_display_supports_input_shapes(@self);
end;
...
begin
  if x_hot <> nil then x_hot^ := 0;
  if y_hot <> nil then y_hot^ := 0;
  Result := nil;
end;
...
begin
  Result := TGdkDeviceType(0);
end;

function TGdkDevice.get_display: PGdkDisplay; cdecl;
begin
  Result := LazGdk4.gdk_device_get_display(@self);
end;

function TGdkDevice.get_has_cursor: gboolean; cdecl;
begin
  Result := LazGdk4.gdk_device_get_has_cursor(@self);
end;
...
begin
  ...
  if start <> 0 then ;
  if stop <> 0 then ;
  if events <> nil then events^ := nil;
  if n_events <> nil then n_events^ := 0;
  Result := False;
end;
...
begin
  if index_ <> 0 then ;
  if keyval <> nil then keyval^ := 0;
  if modifiers <> nil then FillChar(modifiers^, SizeOf(modifiers^), 0);
  Result := False;
end;
...
begin
  Result := LazGdk4.gdk_device_get_product_id(@self);
end;

function TGdkDevice.get_seat: PGdkSeat; cdecl;
begin
  Result := LazGdk4.gdk_device_get_seat(@self);
end;

function TGdkDevice.get_source: TGdkInputSource; cdecl;
begin
  Result := LazGdk4.gdk_device_get_source(@self);
end;
...
begin
  if window <> nil then ;
  if axes <> nil then ;
  if mask <> nil then FillChar(mask^, SizeOf(mask^), 0);
end;

function TGdkDevice.get_vendor_id: Pgchar; cdecl;
begin
  Result := LazGdk4.gdk_device_get_vendor_id(@self);
end;

function TGdkDevice.get_window_at_position(win_x: Pgint; win_y: Pgint): PGdkWindow; cdecl;
begin
  if win_x <> nil then win_x^ := 0;
  if win_y <> nil then win_y^ := 0;
  Result := nil;
end;
...
begin
  ...
  if PtrUInt(@attributes_mask) <> 0 then ;
  Result := nil;
end;
...
begin
  ...
  if PtrUInt(@flags) <> 0 then ;
  if width <> 0 then ;
  if height <> 0 then ;
  if new_width <> nil then new_width^ := 0;
  if new_height <> nil then new_height^ := 0;
end;

procedure TGdkWindow.add_filter(function_: TGdkFilterFunc; data: gpointer); cdecl;
begin
  if PtrUInt(@function_) <> 0 then ;
  if data <> nil then ;
end;
...
begin
  if x <> 0 then ;
  if y <> 0 then ;
  if parent_x <> nil then parent_x^ := 0;
  if parent_y <> nil then parent_y^ := 0;
end;

function TGdkWindow.create_gl_context(error: PPGError): PGdkGLContext; cdecl;
begin
  if error <> nil then error^ := nil;
  Result := nil;
end;
...
begin
  if decorations <> nil then FillChar(decorations^, SizeOf(decorations^), 0);
  Result := False;
end;
...
begin
  if target <> nil then target^ := nil;
  Result := TGdkDragProtocol(0);
end;
...
begin
  if x <> 0 then ;
  if y <> 0 then ;
  if root_x <> nil then root_x^ := 0;
  if root_y <> nil then root_y^ := 0;
end;
...
begin
  if rect <> nil then ;
  if Ord(rect_anchor) >= 0 then ;
  if Ord(window_anchor) >= 0 then ;
  if PtrUInt(@anchor_hints) <> 0 then ;
  if rect_anchor_dx <> 0 then ;
  if rect_anchor_dy <> 0 then ;
end;
...
begin
  { no-op in GTK4 backend migration path }
end;
...
begin
  ...
  if cursor <> nil then ;
  if event <> nil then ;
  if PtrUInt(@prepare_func) <> 0 then ;
  if prepare_func_data <> nil then ;
  Result := TGdkGrabStatus(0);
end;
...
begin
  Result := LazGdk4.gdk_display_manager_get();
end;

function TGdkDisplayManager.get_default_display: PGdkDisplay; cdecl;
begin
  Result := LazGdk4.gdk_display_manager_get_default_display(@self);
end;

function TGdkDisplayManager.list_displays: PGSList; cdecl;
begin
  Result := LazGdk4.gdk_display_manager_list_displays(@self);
end;

function TGdkDisplayManager.open_display(name: Pgchar): PGdkDisplay; cdecl;
begin
  Result := LazGdk4.gdk_display_manager_open_display(@self, name);
end;

procedure TGdkDisplayManager.set_default_display(display: PGdkDisplay); cdecl;
begin
  LazGdk4.gdk_display_manager_set_default_display(@self, display);
end;
...
begin
  if ipc_window <> nil then ;
  if PtrUInt(@actions) <> 0 then ;
  Result := False;
end;
...
begin
  LazGdk4.gdk_frame_clock_begin_updating(@self);
end;

procedure TGdkFrameClock.end_updating; cdecl;
begin
  LazGdk4.gdk_frame_clock_end_updating(@self);
end;

function TGdkFrameClock.get_current_timings: PGdkFrameTimings; cdecl;
begin
  Result := LazGdk4.gdk_frame_clock_get_current_timings(@self);
end;

function TGdkFrameClock.get_frame_counter: gint64; cdecl;
begin
  Result := LazGdk4.gdk_frame_clock_get_frame_counter(@self);
end;

function TGdkFrameClock.get_frame_time: gint64; cdecl;
begin
  Result := LazGdk4.gdk_frame_clock_get_frame_time(@self);
end;

function TGdkFrameClock.get_history_start: gint64; cdecl;
begin
  Result := LazGdk4.gdk_frame_clock_get_history_start(@self);
end;
...
begin
  if hardware_keycode <> 0 then ;
  if keys <> nil then keys^ := nil;
  if keyvals <> nil then keyvals^ := nil;
  if n_entries <> nil then n_entries^ := 0;
  Result := False;
end;
...
begin
  if hardware_keycode <> 0 then ;
  if PtrUInt(@state) <> 0 then ;
  if group <> 0 then ;
  if keyval <> nil then keyval^ := 0;
  if effective_group <> nil then effective_group^ := 0;
  if level <> nil then level^ := 0;
  if consumed_modifiers <> nil then FillChar(consumed_modifiers^, SizeOf(consumed_modifiers^), 0);
  Result := False;
end;

function TGdkRGBA.copy: PGdkRGBA; cdecl;
begin
  Result := LazGdk4.gdk_rgba_copy(@self);
end;

function TGdkRGBA.equal(p2: PGdkRGBA): gboolean; cdecl;
begin
  Result := LazGdk4.gdk_rgba_equal(@self, p2);
end;

procedure TGdkRGBA.free; cdecl;
begin
  LazGdk4.gdk_rgba_free(@self);
end;

function TGdkRGBA.hash: guint; cdecl;
begin
  Result := LazGdk4.gdk_rgba_hash(@self);
end;

function TGdkRGBA.parse(spec: Pgchar): gboolean; cdecl;
begin
  Result := LazGdk4.gdk_rgba_parse(@self, spec);
end;

function TGdkRGBA.to_string: Pgchar; cdecl;
begin
  Result := LazGdk4.gdk_rgba_to_string(@self);
end;
...
begin
  if mask <> nil then mask^ := 0;
  if shift <> nil then shift^ := 0;
  if precision <> nil then precision^ := 0;
end;

function TGdkVisual.get_byte_order: TGdkByteOrder; cdecl;
begin
  Result := TGdkByteOrder(0);
end;
...
begin
  Result := TGdkVisualType(0);
end;


{ GTK4 compatibility: GdkWindow is renamed to GdkSurface in GTK4 }
type
  PGdkSurface = PGdkWindow;
  TGdkSurface = TGdkWindow;
end.
