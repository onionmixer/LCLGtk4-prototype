...
uses
  ...
  WSLCLClasses, WSReferences, WSImgList;

type
  { TGtk4WSCustomImageListResolution }

  TGtk4WSCustomImageListResolution = class(TWSCustomImageListResolution)
  published
  ...
  TGtk4WSCustomImageListResolutionClass = class of TGtk4WSCustomImageListResolution;
...
class procedure TGtk4WSCustomImageListResolution.Clear(AList: TCustomImageListResolution);
begin
  inherited Clear(AList);
end;

class function TGtk4WSCustomImageListResolution.CreateReference(AList: TCustomImageListResolution;
...
class procedure TGtk4WSCustomImageListResolution.Delete(AList: TCustomImageListResolution;
  AIndex: Integer);
begin
  inherited Delete(AList, AIndex);
end;

class procedure TGtk4WSCustomImageListResolution.DestroyReference(AComponent: TComponent);
begin
  inherited DestroyReference(AComponent);
end;

class procedure TGtk4WSCustomImageListResolution.Draw(AList: TCustomImageListResolution;
...
class procedure TGtk4WSCustomImageListResolution.Insert(AList: TCustomImageListResolution;
  AIndex: Integer; AData: PRGBAQuad);
begin
  inherited Insert(AList, AIndex, AData);
end;

class procedure TGtk4WSCustomImageListResolution.Move(AList: TCustomImageListResolution; ACurIndex,
  ANewIndex: Integer);
begin
  inherited Move(AList, ACurIndex, ANewIndex);
end;

class procedure TGtk4WSCustomImageListResolution.Replace(AList: TCustomImageListResolution;
  AIndex: Integer; AData: PRGBAQuad);
begin
